    ...
    public void createAnimation() {
        ...
        scaleAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                scaleFloat1 = Float.valueOf(String.valueOf(animation.getAnimatedValue())) ;
                postInvalidate();
            }
        });
        scaleAnim.start();
        ...
        scaleAnim2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
            	...
            	scaleFloat2 = Float.valueOf(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        scaleAnim2.start();
        ...
        rotateAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                degrees = Float.valueOf(String.valueOf(animation.getAnimatedValue())) ;
                postInvalidate();
            }
        });
        rotateAnim.start();
