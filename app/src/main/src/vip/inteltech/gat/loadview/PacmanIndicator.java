    ...
    public void createAnimation() {
        ...
        translationAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                translateX = Float.valueOf(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        ...
        alphaAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                alpha = Integer.valueOf(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        alphaAnim.start();
        ...
        rotateAnim1.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                degrees1 = Float.valueOf(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        rotateAnim1.start();
        ...
        rotateAnim2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                degrees2 = Float.valueOf(String.valueOf(animation.getAnimatedValue()));
                postInvalidate();
            }
        });
        rotateAnim2.start();
