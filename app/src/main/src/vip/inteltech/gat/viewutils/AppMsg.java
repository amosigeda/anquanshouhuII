...
public class AppMsg {
     ...
     */
    private static AppMsg makeText(Activity context, String text, Style style, View view, boolean floating) {
     ...
     * @param floating true if it'll float.
     */
    private static AppMsg makeText(Activity context, String text, Style style, View view, boolean floating, float textSize) {
    ...
    public static AppMsg makeText(Activity context, int resId, Style style, View customView, boolean floating) {
        return makeText(context, resId, style, customView, floating);
    }
    ...
    public static AppMsg makeText(Activity context, int resId, Style style)
        ...
        return makeText(context, resId, style);
    }
    ...
    public static AppMsg makeText(Activity context, int resId, Style style, int layoutId)
            throws Resources.NotFoundException {
        return makeText(context, resId, style, layoutId);
    }
