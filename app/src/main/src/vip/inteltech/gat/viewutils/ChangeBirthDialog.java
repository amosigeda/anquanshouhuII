	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		wvYear.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				selectYear = Integer.valueOf(currentText);
		...
		wvMonth.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				selectMonth = Integer.parseInt(currentText);
		...
		wvDay.addChangingListener(new OnWheelChangedListener() {
			...
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				selectDay = Integer.parseInt(currentText);
			}
		});
	...
	public void onClick(View v) {
		...
		if (v == btnSure) {
			if (onBirthListener != null) {
				/*Date date = new Date(selectYear , selectMonth, selectDay);
	...
	public void setTextviewSize(String curriteItemText, CalendarTextAdapter adapter) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (curriteItemText.equals(currentText)) {
				textvew.setTextSize(TypedValue.COMPLEX_UNIT_DIP, maxTextSize);
			} else {
